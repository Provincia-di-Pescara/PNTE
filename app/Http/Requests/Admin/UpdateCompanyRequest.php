...
final class UpdateCompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'partita_iva' => ['required', 'string', 'size:11', Rule::unique('companies', 'partita_iva')->ignore($company->id), 'regex:/^\d{11}$/'],
            'codice_fiscale' => ['nullable', 'string', 'size:16', Rule::unique('companies', 'codice_fiscale')->ignore($company->id)],
