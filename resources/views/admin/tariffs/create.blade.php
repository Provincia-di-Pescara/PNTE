...
@section('title', 'Aggiungi coefficiente tariffario')
...
<div class="mb-6">
    <nav class="text-sm text-slate-500 mb-2">
        ...
        <span>Nuovo coefficiente</span>
    </nav>
    <h1 class="text-xl font-bold text-slate-900">Aggiungi coefficiente tariffario</h1>
</div>
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <textarea id="note" name="note" rows="3"
                          class="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 @error('note') border-red-400 @enderror">{{ old('note') }}</textarea>
