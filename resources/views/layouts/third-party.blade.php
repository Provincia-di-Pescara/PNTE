...
@section('nav-items')
    @php
        $nav = [
            ['icon' => 'doc',      'label' => 'Pareri', 'route' => 'dashboard', 'pattern' => 'dashboard', 'badge' => null],
            ['icon' => 'cone',     'label' => 'Cantieri', 'route' => 'third-party.roadworks.index', 'pattern' => 'third-party.roadworks.*', 'badge' => null],
            ['icon' => 'clock',    'label' => 'Storico', 'route' => null, 'pattern' => 'storico.*', 'badge' => null],
            ['icon' => 'euro',     'label' => 'Tariffario', 'route' => null, 'pattern' => 'tariffario.*', 'badge' => null],
            ['icon' => 'map',      'label' => 'Mappa territorio', 'route' => null, 'pattern' => 'mappa.*', 'badge' => null],
        ];
    @endphp
