...
<head>
    ...
    <title>@yield('title', 'Ente Terzo') — GTE Abruzzo</title>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex h-14 items-center justify-between">
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('third-party.roadworks.index') }}"
                       class="px-3 py-1.5 rounded-md text-sm font-medium {{ request()->routeIs('third-party.roadworks*') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100' }} transition-colors">
                        Cantieri
                    </a>
                </div>
